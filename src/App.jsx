...
<<<<<<< HEAD
              <input
                ...
                className="bg-black/30 rounded-xl px-4 py-3 border border-white/10 focus:border-indigo-400 outline-none"
              />
              <input
                type="email"
                name="email"
              ...
              <textarea
                ...
                className="bg-black/30 rounded-xl px-4 py-3 border border-white/10 focus:border-indigo-400 outline-none"
              />
              <button className="magnetic inline-flex justify-center px-6 py-3 rounded-2xl bg-indigo-500 hover:bg-indigo-600 transition shadow-lg font-medium">
                Send
              </button>
=======
...
>>>>>>> 85a4210deb72c0ee7267a043dd153f25b352d535
            </div>
          </form>
        </div>
      </section>
...
{/* yo  */}
      ...
      <footer className="py-10 text-center text-gray-500 text-sm">
        © {new Date().getFullYear()} Monu Gupta — Game Developer
=======
